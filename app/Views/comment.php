                                    ...
                                    <?php foreach ($projects as $project): ?>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="row align-items-start">
                                                <!-- Use align-items-start to align items at the top -->
                                                <div class="col-xl-7">
                                                    <div class="position-relative">
                                                        <div class="position-absolute start-0 top-0 ms-3">
                                                            <!-- Use top-0 to position at the top -->
                                                            <h3 class="text-white">
                                                                <?= $project->title ?>
                                                            </h3>
                                                            <p class="text-300">
                                                        ...
                                                        <img class="portfolio-img img-fluid"
                                                            src="<?= base_url('assets/images/' . $project->id_photos) ?>"
                                                            alt="" />
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 mt-4">
                                                    ...
                                                    <div class="d-flex gap-3 mt-3">
                                                        ...
                                                        <button class="btn btn-secondary"
                                                            onclick="commentProject(<?= $project->id ?>)">
